    ...
    return (
        <section className="py-16 md:py-24 lg:py-32 bg-white border-t border-gray-200">
            <div className="max-w-[1400px] mx-auto px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 mb-16 md:mb-20 items-center">
                    {/* Left: Visual */}
                    <div className="order-2 lg:order-1">
                        <div className="border-2 bg-white p-8 md:p-12 min-h-[250px] md:min-h-[350px] flex items-center justify-center relative rounded-2xl" style={{ borderColor: COLORS.BLUE }}>
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-6">
                            <span className="md:hidden">必要なデータ項目と型を定義します。</span>
                            <span className="hidden md:inline">まず、必要なデータ項目とその型を定義します。「会社名」「業種」「従業員数」「URL」など、
                                ビジネスに必要な情報を指定。これがAIのデータ生成の設計図となります。</span>
                        </p>
                        <div className="border-l-2 pl-4 hidden md:block" style={{ borderColor: COLORS.BLUE }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 mb-16 md:mb-20 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-6">
                            <span className="md:hidden">条件を指定するだけで、AIが該当企業を自動抽出します。</span>
                            <span className="hidden md:inline">「東京のFintech企業50社」「年商10億円以上のSaaS企業」など、
                                条件を指定するだけ。AIが該当企業を自動で抽出し、Web検索を通じて
                                最新の企業情報、ニュース、財務データまで収集します。</span>
                        </p>
                        <div className="border-l-2 pl-4 hidden md:block" style={{ borderColor: COLORS.PINK }}>
                            <p className="text-sm font-mono text-gray-500">
                                数日かかるリサーチ作業が、数分で完了
                            </p>
                        </div>
                    ...
                    {/* Right: Visual */}
                    <div>
                        <div className="border-2 bg-white p-8 md:p-12 min-h-[250px] md:min-h-[350px] flex items-center justify-center relative rounded-2xl" style={{ borderColor: COLORS.PINK }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
                    {/* Left: Visual */}
                    <div className="order-2 lg:order-1">
                        <div className="border-2 border-gray-200 bg-gray-50 p-8 md:p-12 min-h-[250px] md:min-h-[300px] flex items-center justify-center relative rounded-2xl">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-6">
                            <span className="md:hidden">自然言語で質問するだけで、AIが分析結果を提供します。</span>
                            <span className="hidden md:inline">「成長率の高い企業トップ10は？」「先月追加されたリードで商談確度の高いものは？」
                                など、自然言語で質問するだけ。複雑なSQLクエリは不要です。
                                AIが瞬時に分析し、ビジネスインサイトを提供します。</span>
                        </p>
                        <div className="border-l-2 pl-4 hidden md:block" style={{ borderColor: COLORS.GREEN }}>
                            <p className="text-sm font-mono text-gray-500">
